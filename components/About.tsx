  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-start py-12 md:py-1">
      <div className="md:col-span-8 reveal">
        <h2 className="text-3xl md:text-6xl font-bold leading-[0.95] uppercase tracking-tighter mb-12">
          Italian-born<br />
        ...
        <div className="space-y-6 text-xl md:text-3xl font-bold uppercase leading-none tracking-tighter reveal reveal-delay-1">
      ...
      <div className="md:col-span-4 reveal reveal-delay-2 mt-12 md:mt-0">
        <div className="relative group overflow-hidden">
          ...
          <div className="absolute bottom-6 left-6 text-right">
            ...
            <p className="text-[10px] uppercase tracking-widest mt-1">Dapper Dan<br />x Saint Laurent</p>
          </div>
        </div>
      </div>
    </div>
