  ...
  return (
    <footer className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-24 py-24 md:py-1 items-start">
      <div className="md:col-span-5 reveal">
        <h2 className="text-7xl md:text-[10vw] font-bold uppercase leading-[0.8] tracking-tighter mb-16">
          Get in<br />Touch
        </h2>
        ...
        <div className="space-y-12">
          <div>
            <p className="text-[10px] uppercase tracking-[0.3em] opacity-40 mb-2">Email</p>
            <a
              href="mailto:fr.sparacia@gmail.com"
              className="text-2xl md:text-3xl font-bold uppercase border-b border-white pb-1 hover:opacity-50 transition-all"
            >
          ...
          <div>
            <p className="text-[10px] uppercase tracking-[0.3em] opacity-40 mb-2">Based in</p>
            <p className="text-2xl md:text-3xl font-bold uppercase">Paris, FR</p>
          </div>
        </div>
      </div>
