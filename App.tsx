  ...
  return (
    <div className="bg-black text-white min-h-screen selection:bg-white selection:text-black">
      <main className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-24 transition-opacity duration-1000 opacity-0 pb-24">
        ...
        <section id="about" className="mt-28 md:mt-28">
          <About />
        </section>

        <section id="education-skills" className="mt-24 md:mt-24>
          <EducationSkills />
        </section>

        <section id="contact" className="mt-10 border-t border-white/10 pt-24  md:pt-20">
          <Footer />
        </section>
      </main>
    </div>
